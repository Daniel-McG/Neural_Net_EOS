...
def tune_asha(num_samples, max_number_of_training_epochs):
    ...
    layer_size_dist = tune.randint(
        lower_limit_of_neurons_per_layer, upper_limit_of_neurons_per_layer
    )
    ...
    scheduler = ASHAScheduler(
        max_t=max_number_of_training_epochs, grace_period=1000000, reduction_factor=2
    )
