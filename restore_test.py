...
class BasicLightning(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        '''
        optimiser = torch.optim.Adam(self.parameters(),lr = self.lr,fused=True)
...
def train_func(config):
    ...
    trainer = pl.Trainer(
        ...
        callbacks=[
                   ...
                   EarlyStopping(monitor="val_loss",mode="min",patience=50000)
                   ],
...
def tune_asha(num_samples,max_number_of_training_epochs):
    ...
    search_space = {
                    ...
                    "weight_decay_coefficient":tune.uniform(1e-3,1e-2)
                    }
    ...
    scheduler = ASHAScheduler(max_t= max_number_of_training_epochs, grace_period=100000, reduction_factor=2)
