...
# cp_from_thermo_relation = arr[non_zero_betaT_index,cv_column].flatten() + (arr[non_zero_betaT_index,temperature_column].flatten()/arr[non_zero_betaT_index,density_column].flatten())*((arr[non_zero_betaT_index,alphaP_column].flatten()**2)/arr[non_zero_betaT_index,betaT_column].flatten())
...
# cp_from_data_coallation = arr[non_zero_betaT_index,cp_column].flatten()
